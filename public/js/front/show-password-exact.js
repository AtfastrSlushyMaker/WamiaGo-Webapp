/**
 * Show Password Animation - Perfect Match
 * Exact implementation of show-password-animation.html functionality
 */
document.addEventListener('DOMContentLoaded', () => {
  console.log("Show password animation initialized");
  ...
  document.querySelectorAll('.toggle-password').forEach(button => {
    ...
    // Create proxy element for text scrambling (like in the demo)
